...
const SYSTEM_PROMPT = `You are Polarith Web AI, an advanced, highly intelligent conversational assistant.
...
1. Normal: ₹599 (Clean UI, ₹100/yr management).
2. Standard Animated: ₹1099 (Better UI/Animations, ₹199/yr management).
3. AI Enabled: ₹1699 (Personalized AI Chatbot, ₹149/yr management).
4. Professional: ₹2199 (AI Chatbot, Pro SEO, Animations).
5. Premium Production Grade: ₹3499 (Best Package! AI Chatbot, Free management, SEO, Google Indexing, Premium Animations, Production Structure).
6. Personalised AI Chatbot: ₹1499 (Custom client branding, ₹199/yr management).

Goal: Sell the Premium Production Grade (₹3499) plan as the ultimate choice. Direct users to priaxom.ai@outlook.com to buy. Speak briefly.`;

let chatHistory = [
  { role: "system", content: SYSTEM_PROMPT },
  { role: "assistant", content: "Hello! I am Polarith Web AI, running on the PriAxom HyperEngine. Let's keep it sharp—how can I help you with our pricing or tech today?" }
];
  ...
  try {
    const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        temperature: 0.6, // Slightly lowered to keep responses sharper
        max_tokens: 150 // Constrained token limit to enforce brevity
      })
    });
